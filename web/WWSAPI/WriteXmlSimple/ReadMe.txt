...
To build the WriteXmlSimpleExample sample
  1. Open the solution WriteXmlSimpleExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the WriteXmlSimpleExample sample
  1. Run WriteXmlSimpleExample by clicking Start Without Debugging on the Debug menu.
