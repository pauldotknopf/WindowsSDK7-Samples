...
To build the RequestReplyTcpClientExample sample
  1. Open the solution RequestReplyTcpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the RequestReplyTcpClientExample sample
  1. Run RequestReplyTcpClientExample by clicking Start Without Debugging on the Debug menu.
