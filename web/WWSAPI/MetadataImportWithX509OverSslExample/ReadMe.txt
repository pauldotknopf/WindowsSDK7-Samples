...
that supports using a X509 token using WS_XML_TOKEN_MESSAGE_SECURITY_BINDING
with WS_SSL_TRANSPORT_SECURITY_BINDING.
...
To build the MetadataImportWithX509OverSslExample sample
  1. Open the solution MetadataImportWithX509OverSslExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the MetadataImportWithX509OverSslExample sample
  1. Run MetadataImportWithX509OverSslExample by clicking Start Without Debugging on the Debug menu.
