...
To build the StreamingTcpClientExample sample
  1. Open the solution StreamingTcpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the StreamingTcpClientExample sample
  1. Run StreamingTcpClientExample by clicking Start Without Debugging on the Debug menu.
