...
To build the XmlDictionaryExample sample
  1. Open the solution XmlDictionaryExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the XmlDictionaryExample sample
  1. Run XmlDictionaryExample by clicking Start Without Debugging on the Debug menu.
