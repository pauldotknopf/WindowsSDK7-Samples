...
To build the MessageEncodingExample sample
  1. Open the solution MessageEncodingExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the MessageEncodingExample sample
  1. Run MessageEncodingExample by clicking Start Without Debugging on the Debug menu.
