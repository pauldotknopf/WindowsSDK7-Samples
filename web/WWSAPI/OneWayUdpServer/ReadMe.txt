...
This example shows a UDP server that accepts a channel and
receives one-way messages.
...
To build the OneWayUdpServerExample sample
  1. Open the solution OneWayUdpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the OneWayUdpServerExample sample
  1. Run OneWayUdpServerExample by clicking Start Without Debugging on the Debug menu.
