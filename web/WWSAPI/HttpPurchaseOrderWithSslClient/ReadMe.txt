...
This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.
...
To build the HttpPurchaseOrderWithSslClientExample sample
  1. Open the solution HttpPurchaseOrderWithSslClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpPurchaseOrderWithSslClientExample sample
  1. Run HttpPurchaseOrderWithSslClientExample by clicking Start Without Debugging on the Debug menu.
