HttpPurchaseOrderWithKerberosOverSslServiceExample
...
To build the HttpPurchaseOrderWithKerberosOverSslServiceExample sample
  1. Open the solution HttpPurchaseOrderWithKerberosOverSslServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpPurchaseOrderWithKerberosOverSslServiceExample sample
  1. Run HttpPurchaseOrderWithKerberosOverSslServiceExample by clicking Start Without Debugging on the Debug menu.
