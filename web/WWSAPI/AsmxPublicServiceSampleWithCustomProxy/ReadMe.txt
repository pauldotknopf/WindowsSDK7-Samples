...
This examples shows service proxy talking to http://terraservice.net/TerraService2.asmx
using WS_HTTP_PROXY_SETTING_MODE_CUSTOMchannel property.
...
To build the AsmxTerraServiceSampleWithCustomProxy sample
  1. Open the solution AsmxTerraServiceSampleWithCustomProxy.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the AsmxTerraServiceSampleWithCustomProxy sample
  1. Run AsmxTerraServiceSampleWithCustomProxy by clicking Start Without Debugging on the Debug menu.
