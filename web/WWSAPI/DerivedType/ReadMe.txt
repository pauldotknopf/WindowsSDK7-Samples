...
This example writes and reads derived types using Wsutil generated C++ helper functions.
See WS_TYPE_ATTRIBUTE_FIELD_MAPPINGfor more about derived type descriptions.
...
To build the DerivedTypeExample sample
  1. Open the solution DerivedTypeExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the DerivedTypeExample sample
  1. Run DerivedTypeExample by clicking Start Without Debugging on the Debug menu.
