HttpCalculatorWithSslServiceExample

Description
===========

This example shows how to use service host for hosting a calculator service over HTTP, with SSL transport security.
...
To build the HttpCalculatorWithSslServiceExample sample
  1. Open the solution HttpCalculatorWithSslServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithSslServiceExample sample
  1. Run HttpCalculatorWithSslServiceExample by clicking Start Without Debugging on the Debug menu.
