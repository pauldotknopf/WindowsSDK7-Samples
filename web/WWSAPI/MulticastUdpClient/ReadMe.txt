...
To build the MulticastUdpClientExample sample
  1. Open the solution MulticastUdpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the MulticastUdpClientExample sample
  1. Run MulticastUdpClientExample by clicking Start Without Debugging on the Debug menu.
