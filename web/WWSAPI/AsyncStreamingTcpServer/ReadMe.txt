...
This example shows a TCP server that receives one-way messages
in an asynchronous streaming fashion.
...
To build the AsyncStreamingTcpServerExample sample
  1. Open the solution AsyncStreamingTcpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the AsyncStreamingTcpServerExample sample
  1. Run AsyncStreamingTcpServerExample by clicking Start Without Debugging on the Debug menu.
