...
To build the HttpClientWithKerberosOverSslExample sample
  1. Open the solution HttpClientWithKerberosOverSslExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpClientWithKerberosOverSslExample sample
  1. Run HttpClientWithKerberosOverSslExample by clicking Start Without Debugging on the Debug menu.
