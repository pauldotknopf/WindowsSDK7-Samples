...
using a custom channel.  The channel is uses a custom encoder.
...
To build the HttpCalculatorWithEncodedChannelClientExample sample
  1. Open the solution HttpCalculatorWithEncodedChannelClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithEncodedChannelClientExample sample
  1. Run HttpCalculatorWithEncodedChannelClientExample by clicking Start Without Debugging on the Debug menu.
