...
To build the UnTypedClientExample sample
  1. Open the solution UnTypedClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the UnTypedClientExample sample
  1. Run UnTypedClientExample by clicking Start Without Debugging on the Debug menu.
