...
This example shows a TCP client that sends a one-way messages.
...
To build the OneWayTcpClientExample sample
  1. Open the solution OneWayTcpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the OneWayTcpClientExample sample
  1. Run OneWayTcpClientExample by clicking Start Without Debugging on the Debug menu.
