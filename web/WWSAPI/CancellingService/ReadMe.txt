...
To build the BlockingServiceExample sample
  1. Open the solution BlockingServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the BlockingServiceExample sample
  1. Run BlockingServiceExample by clicking Start Without Debugging on the Debug menu.
