...
To build the ReadAttributeExample sample
  1. Open the solution ReadAttributeExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ReadAttributeExample sample
  1. Run ReadAttributeExample by clicking Start Without Debugging on the Debug menu.
