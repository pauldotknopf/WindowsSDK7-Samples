...
To build the HttpCalculatorWithKerberosOverSslClientExample sample
  1. Open the solution HttpCalculatorWithKerberosOverSslClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithKerberosOverSslClientExample sample
  1. Run HttpCalculatorWithKerberosOverSslClientExample by clicking Start Without Debugging on the Debug menu.
