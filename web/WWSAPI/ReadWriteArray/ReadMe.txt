...
To build the ReadWriteArrayExample sample
  1. Open the solution ReadWriteArrayExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ReadWriteArrayExample sample
  1. Run ReadWriteArrayExample by clicking Start Without Debugging on the Debug menu.
