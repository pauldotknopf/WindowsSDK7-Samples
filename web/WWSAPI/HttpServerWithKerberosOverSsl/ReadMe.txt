...
and replies to messages, with kerberos over SSL mixed-mode security.
...
authentication is provided by a kerberos APREQ ticket in a
...
To build the HttpServerWithKerberosOverSslExample sample
  1. Open the solution HttpServerWithKerberosOverSslExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpServerWithKerberosOverSslExample sample
  1. Run HttpServerWithKerberosOverSslExample by clicking Start Without Debugging on the Debug menu.
