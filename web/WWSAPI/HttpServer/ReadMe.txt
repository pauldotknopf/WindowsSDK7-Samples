...
To build the HttpServerExample sample
  1. Open the solution HttpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpServerExample sample
  1. Run HttpServerExample by clicking Start Without Debugging on the Debug menu.
