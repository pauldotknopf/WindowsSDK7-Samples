...
This example shows a TCP server that accepts a channel and
receives and replies to messages, with security provided by Windows SSPI-based transport security.
...
To build the RequestReplyTcpServerWithWindowsTransportSecurityExample sample
  1. Open the solution RequestReplyTcpServerWithWindowsTransportSecurityExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the RequestReplyTcpServerWithWindowsTransportSecurityExample sample
  1. Run RequestReplyTcpServerWithWindowsTransportSecurityExample by clicking Start Without Debugging on the Debug menu.
