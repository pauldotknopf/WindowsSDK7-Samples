...
address and replies to requests sent to that address.
...
To build the MulticastUdpServerExample sample
  1. Open the solution MulticastUdpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the MulticastUdpServerExample sample
  1. Run MulticastUdpServerExample by clicking Start Without Debugging on the Debug menu.
