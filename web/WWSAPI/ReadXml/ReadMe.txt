...
This example reads XML node by node.
...
To build the ReadXmlExample sample
  1. Open the solution ReadXmlExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ReadXmlExample sample
  1. Run ReadXmlExample by clicking Start Without Debugging on the Debug menu.
