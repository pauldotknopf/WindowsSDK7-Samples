...
To build the SessionfullCalculatorClientExample sample
  1. Open the solution SessionfullCalculatorClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the SessionfullCalculatorClientExample sample
  1. Run SessionfullCalculatorClientExample by clicking Start Without Debugging on the Debug menu.
