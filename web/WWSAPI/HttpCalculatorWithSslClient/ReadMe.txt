...
This example show how to use the service proxy to talk to a calculator service, with SSL transport security.
...
To build the HttpCalculatorWithSslClientExample sample
  1. Open the solution HttpCalculatorWithSslClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithSslClientExample sample
  1. Run HttpCalculatorWithSslClientExample by clicking Start Without Debugging on the Debug menu.
