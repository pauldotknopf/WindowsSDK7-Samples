...
This example shows how to use service host to handle raw (non-SOAP) HTTP requests.
...
To build the HttpRawServiceExample sample
  1. Open the solution HttpRawServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpRawServiceExample sample
  1. Run HttpRawServiceExample by clicking Start Without Debugging on the Debug menu.
