...
This example writes binary data using the MTOM encoding and reads it back out.
...
To build the ReadWriteBytesXmlExample sample
  1. Open the solution ReadWriteBytesXmlExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ReadWriteBytesXmlExample sample
  1. Run ReadWriteBytesXmlExample by clicking Start Without Debugging on the Debug menu.
