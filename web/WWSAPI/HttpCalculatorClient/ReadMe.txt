...
To build the HttpCalculatorClientExample sample
  1. Open the solution HttpCalculatorClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorClientExample sample
  1. Run HttpCalculatorClientExample by clicking Start Without Debugging on the Debug menu.
