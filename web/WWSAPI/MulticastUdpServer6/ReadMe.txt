...
This example shows a UDP server that listens on a multicast
address and replies to requests sent to that address.  This
example uses IPv6.
...
To build the MulticastUdpServerExample6 sample
  1. Open the solution MulticastUdpServerExample6.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the MulticastUdpServerExample6 sample
  1. Run MulticastUdpServerExample6 by clicking Start Without Debugging on the Debug menu.
