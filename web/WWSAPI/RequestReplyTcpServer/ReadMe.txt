...
To build the RequestReplyTcpServerExample sample
  1. Open the solution RequestReplyTcpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the RequestReplyTcpServerExample sample
  1. Run RequestReplyTcpServerExample by clicking Start Without Debugging on the Debug menu.
