...
To build the HttpClientExample sample
  1. Open the solution HttpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpClientExample sample
  1. Run HttpClientExample by clicking Start Without Debugging on the Debug menu.
