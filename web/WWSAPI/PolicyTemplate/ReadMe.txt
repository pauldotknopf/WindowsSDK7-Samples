...
This example illustrates how to manually create policy description and use it
to create service proxy.
...
To build the PolicyTemplateExample sample
  1. Open the solution PolicyTemplateExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the PolicyTemplateExample sample
  1. Run PolicyTemplateExample by clicking Start Without Debugging on the Debug menu.
