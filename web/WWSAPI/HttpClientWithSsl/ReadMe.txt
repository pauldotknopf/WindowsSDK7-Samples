...
To build the HttpClientWithSslExample sample
  1. Open the solution HttpClientWithSslExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpClientWithSslExample sample
  1. Run HttpClientWithSslExample by clicking Start Without Debugging on the Debug menu.
