...
This example shows an HTTP client that does request-reply
...
To build the StreamingHttpClientExample sample
  1. Open the solution StreamingHttpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the StreamingHttpClientExample sample
  1. Run StreamingHttpClientExample by clicking Start Without Debugging on the Debug menu.
