...
This example shows a HTTP client that uses service proxy to talk to a calculator service,
...
To build the HttpCalculatorWithUsernameOverSslClientExample sample
  1. Open the solution HttpCalculatorWithUsernameOverSslClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithUsernameOverSslClientExample sample
  1. Run HttpCalculatorWithUsernameOverSslClientExample by clicking Start Without Debugging on the Debug menu.
