...
To build the OneWayUdpClientExample sample
  1. Open the solution OneWayUdpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the OneWayUdpClientExample sample
  1. Run OneWayUdpClientExample by clicking Start Without Debugging on the Debug menu.
