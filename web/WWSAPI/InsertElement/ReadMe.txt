...
To build the InsertElementExample sample
  1. Open the solution InsertElementExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the InsertElementExample sample
  1. Run InsertElementExample by clicking Start Without Debugging on the Debug menu.
