...
To build the HttpCalculatorWithEncodedChannelServiceExample sample
  1. Open the solution HttpCalculatorWithEncodedChannelServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithEncodedChannelServiceExample sample
  1. Run HttpCalculatorWithEncodedChannelServiceExample by clicking Start Without Debugging on the Debug menu.
