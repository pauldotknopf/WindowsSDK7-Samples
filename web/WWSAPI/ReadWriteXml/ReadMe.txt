...
To build the ReadWriteXmlExample sample
  1. Open the solution ReadWriteXmlExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ReadWriteXmlExample sample
  1. Run ReadWriteXmlExample by clicking Start Without Debugging on the Debug menu.
