...
To build the NavigateXmlExample sample
  1. Open the solution NavigateXmlExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the NavigateXmlExample sample
  1. Run NavigateXmlExample by clicking Start Without Debugging on the Debug menu.
