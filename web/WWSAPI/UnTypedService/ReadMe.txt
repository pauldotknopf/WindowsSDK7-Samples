...
This sample shows how implement an untyped service with Service Model.
Service Model in this case provides the boiler plate infrastructure.
...
To build the UnTypedServiceExample sample
  1. Open the solution UnTypedServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the UnTypedServiceExample sample
  1. Run UnTypedServiceExample by clicking Start Without Debugging on the Debug menu.
