...
This example shows how to use service host for hosting a calculator service with
a custom channel and listener implementation that layer on top of HTTP.
...
To build the HttpCalculatorWithLayeredChannelServiceExample sample
  1. Open the solution HttpCalculatorWithLayeredChannelServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithLayeredChannelServiceExample sample
  1. Run HttpCalculatorWithLayeredChannelServiceExample by clicking Start Without Debugging on the Debug menu.
