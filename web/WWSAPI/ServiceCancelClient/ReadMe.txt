...
To build the ServiceCancellationExample sample
  1. Open the solution ServiceCancellationExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ServiceCancellationExample sample
  1. Run ServiceCancellationExample by clicking Start Without Debugging on the Debug menu.
