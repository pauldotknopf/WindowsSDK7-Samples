...
To build the HttpPurchaseOrderWithSslServiceExample sample
  1. Open the solution HttpPurchaseOrderWithSslServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpPurchaseOrderWithSslServiceExample sample
  1. Run HttpPurchaseOrderWithSslServiceExample by clicking Start Without Debugging on the Debug menu.
