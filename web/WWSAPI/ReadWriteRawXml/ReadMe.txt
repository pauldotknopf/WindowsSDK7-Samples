...
To build the ReadWriteRawXmlExample sample
  1. Open the solution ReadWriteRawXmlExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ReadWriteRawXmlExample sample
  1. Run ReadWriteRawXmlExample by clicking Start Without Debugging on the Debug menu.
