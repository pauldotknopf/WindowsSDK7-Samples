...
To build the CustomHeaderExample sample
  1. Open the solution CustomHeaderExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the CustomHeaderExample sample
  1. Run CustomHeaderExample by clicking Start Without Debugging on the Debug menu.
