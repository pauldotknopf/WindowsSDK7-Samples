...
This example shows how to use the wsutil generated policy helper routines
...
To build the HttpCalculatorWithSslPolicyClientExample sample
...
To run the HttpCalculatorWithSslPolicyClientExample sample
