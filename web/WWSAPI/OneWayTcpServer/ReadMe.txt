...
To build the OneWayTcpServerExample sample
  1. Open the solution OneWayTcpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the OneWayTcpServerExample sample
  1. Run OneWayTcpServerExample by clicking Start Without Debugging on the Debug menu.
