...
To build the HttpCustomHeaderPurchaseOrderServiceExample sample
  1. Open the solution HttpCustomHeaderPurchaseOrderServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCustomHeaderPurchaseOrderServiceExample sample
  1. Run HttpCustomHeaderPurchaseOrderServiceExample by clicking Start Without Debugging on the Debug menu.
