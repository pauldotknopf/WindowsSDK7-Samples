...
To build the ForwardMessageExample sample
  1. Open the solution ForwardMessageExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ForwardMessageExample sample
  1. Run ForwardMessageExample by clicking Start Without Debugging on the Debug menu.
