...
To build the XmlBufferExample sample
  1. Open the solution XmlBufferExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the XmlBufferExample sample
  1. Run XmlBufferExample by clicking Start Without Debugging on the Debug menu.
