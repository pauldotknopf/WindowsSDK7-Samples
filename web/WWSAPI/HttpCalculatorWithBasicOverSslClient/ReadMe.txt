...
This example shows how to use the service proxy to talk to a
calculator service, with SSL transport security and HTTP header basic
...
To build the HttpCalculatorWithBasicOverSslClientExample sample
  1. Open the solution HttpCalculatorWithBasicOverSslClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithBasicOverSslClientExample sample
  1. Run HttpCalculatorWithBasicOverSslClientExample by clicking Start Without Debugging on the Debug menu.
