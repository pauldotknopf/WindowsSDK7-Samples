...
To build the HttpCalculatorWithSslPolicyServiceExample sample
  1. Open the solution HttpCalculatorWithSslPolicyServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCalculatorWithSslPolicyServiceExample sample
  1. Run HttpCalculatorWithSslPolicyServiceExample by clicking Start Without Debugging on the Debug menu.
