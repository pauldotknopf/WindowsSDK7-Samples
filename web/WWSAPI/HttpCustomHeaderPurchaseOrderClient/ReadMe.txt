...
To build the HttpCustomHeaderPurchaseOrderClientExample sample
  1. Open the solution HttpCustomHeaderPurchaseOrderClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpCustomHeaderPurchaseOrderClientExample sample
  1. Run HttpCustomHeaderPurchaseOrderClientExample by clicking Start Without Debugging on the Debug menu.
