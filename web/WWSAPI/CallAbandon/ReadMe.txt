...
To build the CallAbandonExample sample
  1. Open the solution CallAbandonExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the CallAbandonExample sample
  1. Run CallAbandonExample by clicking Start Without Debugging on the Debug menu.
