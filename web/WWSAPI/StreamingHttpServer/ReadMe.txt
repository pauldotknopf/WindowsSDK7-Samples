...
This example shows an HTTP server that accepts a channel,
and does request-reply processing in a streaming fashion.
...
To build the StreamingHttpServerExample sample
  1. Open the solution StreamingHttpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the StreamingHttpServerExample sample
  1. Run StreamingHttpServerExample by clicking Start Without Debugging on the Debug menu.
