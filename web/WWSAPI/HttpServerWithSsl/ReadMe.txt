...
receives and replies to messages, with SSL transport security.
...
To build the HttpServerWithSslExample sample
  1. Open the solution HttpServerWithSslExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpServerWithSslExample sample
  1. Run HttpServerWithSslExample by clicking Start Without Debugging on the Debug menu.
