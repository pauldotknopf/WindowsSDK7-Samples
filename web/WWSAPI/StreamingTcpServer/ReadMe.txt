...
This example shows a TCP server that accepts a channel,
and reads one-way messages in a streaming fashion.
...
To build the StreamingTcpServerExample sample
  1. Open the solution StreamingTcpServerExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the StreamingTcpServerExample sample
  1. Run StreamingTcpServerExample by clicking Start Without Debugging on the Debug menu.
