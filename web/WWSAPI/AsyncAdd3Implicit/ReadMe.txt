...
This example illustrates implementing a complex asynchronous function using WsAsyncExecute.
...
To build the AsyncAdd3ImplicitExample sample
  1. Open the solution AsyncAdd3ImplicitExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the AsyncAdd3ImplicitExample sample
  1. Run AsyncAdd3ImplicitExample by clicking Start Without Debugging on the Debug menu.
