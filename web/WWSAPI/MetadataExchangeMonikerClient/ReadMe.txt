...
This sample shows a client which can be used with
the TCP MetadataExchange sample. It utilizes WCF service moniker.
...
To build the ServiceMonikerSample sample
  1. Open the solution ServiceMonikerSample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the ServiceMonikerSample sample
  1. Run ServiceMonikerSample by clicking Start Without Debugging on the Debug menu.
