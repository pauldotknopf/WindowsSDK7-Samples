...
To build the HttpPurchaseOrderWithUsernameOverSslClientExample sample
  1. Open the solution HttpPurchaseOrderWithUsernameOverSslClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpPurchaseOrderWithUsernameOverSslClientExample sample
  1. Run HttpPurchaseOrderWithUsernameOverSslClientExample by clicking Start Without Debugging on the Debug menu.
