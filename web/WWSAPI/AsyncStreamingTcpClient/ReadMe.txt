...
This example shows a TCP client that sends one-way messages
...
To build the AsyncStreamingTcpClientExample sample
  1. Open the solution AsyncStreamingTcpClientExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the AsyncStreamingTcpClientExample sample
  1. Run AsyncStreamingTcpClientExample by clicking Start Without Debugging on the Debug menu.
