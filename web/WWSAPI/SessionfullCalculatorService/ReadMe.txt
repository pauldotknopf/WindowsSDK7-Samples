...
To build the SessionfullCalculatorServiceExample sample
  1. Open the solution SessionfullCalculatorServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the SessionfullCalculatorServiceExample sample
  1. Run SessionfullCalculatorServiceExample by clicking Start Without Debugging on the Debug menu.
