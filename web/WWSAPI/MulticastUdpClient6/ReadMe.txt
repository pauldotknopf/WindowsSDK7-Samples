...
This example shows a UDP client that multicasts a request and then waits for
reply messages from servers, using IPv6.
...
To build the MulticastUdpClientExample6 sample
  1. Open the solution MulticastUdpClientExample6.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the MulticastUdpClientExample6 sample
  1. Run MulticastUdpClientExample6 by clicking Start Without Debugging on the Debug menu.
