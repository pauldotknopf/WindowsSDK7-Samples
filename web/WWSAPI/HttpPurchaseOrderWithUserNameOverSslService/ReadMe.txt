...
To build the HttpPurchaseOrderWithUserNameOverSslServiceExample sample
  1. Open the solution HttpPurchaseOrderWithUserNameOverSslServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpPurchaseOrderWithUserNameOverSslServiceExample sample
  1. Run HttpPurchaseOrderWithUserNameOverSslServiceExample by clicking Start Without Debugging on the Debug menu.
