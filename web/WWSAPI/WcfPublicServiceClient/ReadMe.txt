...
This examples shows service proxy talking to http://131.107.72.15/Example_HelloWorld_Service_Indigo/HelloWorld.svc?wsdl.
...
To build the WcfPublicServiceSample sample
  1. Open the solution WcfPublicServiceSample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the WcfPublicServiceSample sample
  1. Run WcfPublicServiceSample by clicking Start Without Debugging on the Debug menu.
