...
To build the HttpPurchaseOrderServiceExample sample
  1. Open the solution HttpPurchaseOrderServiceExample.sln in Visual Studio. 
  2. On the Build menu, click Build. 

Running the Sample
==================

To run the HttpPurchaseOrderServiceExample sample
  1. Run HttpPurchaseOrderServiceExample by clicking Start Without Debugging on the Debug menu.
